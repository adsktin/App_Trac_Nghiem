...
class AcceptMatch extends StatefulWidget {
  const AcceptMatch({super.key});

  @override
  State<AcceptMatch> createState() => _AcceptMatchState();
}
...
class _AcceptMatchState extends State<AcceptMatch> {
  @override
